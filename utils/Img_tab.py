...
result_dir = os.path.expanduser('~/PycharmProjects/PyCIL2/data/Results/Gyro_Conversion/Test_1')
...
result_dir = os.path.expanduser('~/PycharmProjects/PyCIL2/data/Results/Gyro_Conversion/Test_2')
